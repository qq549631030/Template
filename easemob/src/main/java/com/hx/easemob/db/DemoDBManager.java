...
import com.hx.easemob.domain.InviteMessage.InviteMesageStatus;
...
public class DemoDBManager {
    ...
    private DemoDBManager(){
        dbHelper = DbOpenHelper.getInstance(HXSDKHelper.getInstance().getAppContext());
    }
