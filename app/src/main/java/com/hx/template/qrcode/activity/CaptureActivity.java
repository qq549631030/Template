...
import com.hx.template.qrcode.utils.CaptureActivityHandler;
import com.hx.template.qrcode.utils.InactivityTimer;
...
public final class CaptureActivity extends BaseActivity implements SurfaceHolder.Callback {
    ...
    private int scanMode = SCAN_BY_ZXING;
    ...
    public void onCreate(Bundle icicle) {
        ...
        scanMode = getIntent().getIntExtra("mode", SCAN_BY_ZXING);
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        try {
            ...
            // RuntimeException.
            if (handler == null) {
                if (scanMode == SCAN_BY_ZXING) {
                    //Zxing 解码
                    handler = new CaptureActivityHandler(this, cameraManager, ZxingDecodeThread.ALL_MODE);
                } else if (scanMode == SCAN_BY_ZBAR) {
                    //Zbar 解码
                    handler = new CaptureActivityHandler(this, cameraManager, 0);
                }
            }
