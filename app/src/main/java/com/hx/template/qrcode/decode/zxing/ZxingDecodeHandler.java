 ...
 * zxing解码
 */
public class ZxingDecodeHandler extends DecodeHandler {

    private final MultiFormatReader multiFormatReader;
    private boolean running = true;

    public ZxingDecodeHandler(CaptureActivity activity, Map<DecodeHintType, Object> hints) {
        super(activity);
    ...
    private static void bundleThumbnail(PlanarYUVLuminanceSource source, Bundle bundle) {
        ...
        bundle.putByteArray(ZxingDecodeThread.BARCODE_BITMAP, out.toByteArray());
    }
