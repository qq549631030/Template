...
public class AndroidDatabaseConnection implements DatabaseConnection {
	...
	public int executeStatement(String statementStr, int resultFlags) throws SQLException {
		return com.j256.ormlite.sqlcipher.android.AndroidCompiledStatement.execSql(db, statementStr, statementStr, NO_STRING_ARGS);
	}

	public CompiledStatement compileStatement(String statement, StatementType type, FieldType[] argFieldTypes,
			int resultFlags) {
		// resultFlags argument is not used in Android-land since the {@link Cursor} is bi-directional.
		CompiledStatement stmt = new com.j256.ormlite.sqlcipher.android.AndroidCompiledStatement(statement, db, type, cancelQueriesEnabled);
	...
	public <T> Object queryForOne(String statement, Object[] args, FieldType[] argFieldTypes,
		...
		try {
			...
			com.j256.ormlite.sqlcipher.android.AndroidDatabaseResults results = new com.j256.ormlite.sqlcipher.android.AndroidDatabaseResults(cursor, objectCache);
	...
	public long queryForLong(String statement, Object[] args, FieldType[] argFieldTypes) throws SQLException {
		...
		try {
			cursor = db.rawQuery(statement, toStrings(args));
			com.j256.ormlite.sqlcipher.android.AndroidDatabaseResults results = new com.j256.ormlite.sqlcipher.android.AndroidDatabaseResults(cursor, null);
			long result;
			if (results.first()) {
