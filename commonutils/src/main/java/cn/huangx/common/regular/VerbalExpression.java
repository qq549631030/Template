package cn.huangx.common.regular;
...
//            put('U', Pattern.UNICODE_CHARACTER_CLASS);
    ...
    /**
     * Use builder {@link #regex()} (or {@link #regex(cn.huangx.common.regular.VerbalExpression.Builder)})
     * to create new instance of VerbalExpression
     *
     * @param pattern - {@link Pattern} that constructed by builder
     */
