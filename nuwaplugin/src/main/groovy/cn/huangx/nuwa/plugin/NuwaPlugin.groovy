package cn.huangx.nuwa.plugin

import cn.huangx.nuwa.plugin.util.NuwaAndroidUtils
import cn.huangx.nuwa.plugin.util.NuwaFileUtils
import cn.huangx.nuwa.plugin.util.NuwaMapUtils
import cn.huangx.nuwa.plugin.util.NuwaProcessor
import cn.huangx.nuwa.plugin.util.NuwaSetUtils
        ...
        project.afterEvaluate {
            ...
            project.android.applicationVariants.each { variant ->
                ...
                if (!variant.name.contains(DEBUG) || (variant.name.contains(DEBUG) && debugOn)) {
                    ...
                    def dexTask = project.tasks.findByName("package${variant.name.capitalize()}")
                    ...
                    manifestFile=new File("${project.buildDir}/intermediates/manifests/full/mock/debug/AndroidManifest.xml")
